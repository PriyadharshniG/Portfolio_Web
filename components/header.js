          ...
          >
            ...
            <div className="flex justify-end flex-col items-end">
              <motion.h1
                ...
                onClick={() => {setShowDrawer(false); document.getElementById('projects').scrollIntoView()}}
              >
                Projects
              </motion.h1>
              <motion.h1
                ...
                onClick={() => {setShowDrawer(false); document.getElementById('contact').scrollIntoView()}}
              >
                Contact
              </motion.h1>
              <motion.h1
                ...
                onClick={() => window.open("https://drive.google.com/file/d/1UcrpCaZagYpq3QJrMmkUOlt_rjZL-BoV/view?usp=sharing", "_blank")}
              >
                Resume
              </motion.h1>
              <motion.div
                initial={{ x: 460 }}
                animate={{ x: 0 }}
                transition={{ delay: 0.78, duration: 0.7, type: "spring" }}
              ...
              <motion.div
                ...
                initial={{ x: 450 }}
                animate={{ x: 0 }}
                transition={{ delay: 0.84, duration: 0.7, type: "spring" }}
              >
                <motion.svg
                  onClick={() => window.open("https://www.github.com/A-4-Atom", "_blank")}
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 64 64"
                  width="48px"
                  height="48px"
                ...
                <motion.svg
                  onClick={() => window.open("https://www.linkedin.com/in/vikas-chauhan-232182136/", "_blank")}
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 50 50"
                  className="h-10 mt-1"
                ...
                <motion.svg
                  onClick={() => window.open("https://www.instagram.com/a.4.atom/", "_blank")}
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 32 32"
                  className="h-12"
