...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        <h1 className={`heading text-[35px] font-poppins text-darkslateblue font-medium mx-7 cursor-default ${caveat.className}`}>
          VIKAS
        </h1>
          ...
          >
            ...
            <div className="flex justify-end flex-col items-end">
              ...
              <motion.h1
                ...
                onClick={() =>
                  window.open(
                    "https://drive.google.com/file/d/1K-Hnftqh4kpCAFBJavNnNCNn-FO1mxv7/view?usp=sharing",
                    "_blank"
                  )
                }
              >
              ...
              >
                ...
                <motion.svg
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.2, delay: 1.5, ease: "circOut" }}
                >
